...
# -- Wiring section -- 
Connect readers to your mux, use port 0-1-2-3 on mux , the 4-5-6-7 ports if using 8 channel mux doesn't work so be aware
...
Connect mux with readers to pico I2C port then pico to rpi via usb
